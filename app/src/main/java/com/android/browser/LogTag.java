...
public class LogTag {
    ...
    public static void logBookmarkAdded(String url, String where) {
        EventLog.writeEvent(70103/*EventLogTags.BROWSER_BOOKMARK_ADDED*/, url + "|" + where);
    }
    ...
    public static void logPageFinishedLoading(String url, long duration) {
        EventLog.writeEvent(70104/*EventLogTags.BROWSER_PAGE_LOADED*/, url + "|"
            + duration);
    }
    ...
    public static void logTimeOnPage(String url, long duration) {
        EventLog.writeEvent(70105/*EventLogTags.BROWSER_TIMEONPAGE*/, url + "|"
            + duration);
    }
}
